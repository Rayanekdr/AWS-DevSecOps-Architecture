...
mailer.setDefaultSuffix("YOUR-EMAIL")
mailer.setSmtpAuth("YOUR-EMAIL", "${EMAIL_PASSWORD}")
...
emailExt.setDefaultRecipients("YOUR-EMAIL")
emailExt.setDefaultReplyTo("YOUR-EMAIL")
emailExt.setDefaultSubject("Build Notification")
emailExt.setDefaultBody("Build status: \${BUILD_STATUS}")
emailExt.setUseSsl(true)
emailExt.setSmtpAuth("YOUR-EMAIL", "${EMAIL_PASSWORD}")
